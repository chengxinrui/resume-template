...
\textcolor{CVBlue}{\textbf{方向：文本纠错、幻觉治理与检索排序小模型训练与优化}}
\begin{itemize}
    \item 搭建清洗‑标注‑配比‑增强完整数据生产流程，采用三级质量治理方案，完成4W+纠错样本、75W+查询‑文档对的数据治理工作。
    \item 主导中英文纠错4B模型LoRA微调，确定最优样本配比，公开集指标超越原生8B大模型；完成Qwen3‑Reranker 0.6B微调，检索排序多项指标显著提升。
    \item 设计三级测评选优机制，通过分层抽样避免数据泄露，基于多组对照实验筛选最优模型。
    \item 积累大规模数据治理、小模型微调、评测体系建设经验，相关技术可迁移至能源行业文本、时序多模态智能化业务。
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{外语水平：} \underline{填写四六级}，可熟练阅读英文文献，具备英文论文写作投稿经验。
\end{itemize}
