...
\textbf{研究方向：}AI驱动工程仿真加速、数字孪生、计算流体力学代理模型、AI4PDE
% \projectsep
...
\begin{itemize}
    ...
    \item 设计几何解耦编码器(GALA)统一处理1D/2D/3D不规则几何；曲率感知门控(GSEO)保留激波/涡旋等高梯度物理结构。
...
\hfill 2024.9 -- 2025.3
\begin{itemize}
    \item \textbf{背景：}流场在几何突变区域变化最剧烈，但现有模型的注意力机制不感知边的几何结构，关键区域预测误差最大。
